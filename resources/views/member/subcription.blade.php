...
@if($user_premium)
    ...
    <div class="flex flex-col gap-[14px] max-w-max">
        ...
        <a href="{{ route('pricing') }}" class="py-[13px] px-[58px] outline outline-1 outline-stream-gray outline-offset-[-3px] rounded-full text-center">
    ...
    <!-- /Stop Subscribe -->
@else 
    <p class="text-white text-[22px] font-semibold">Tidak ada Subscription</p>
@endif
